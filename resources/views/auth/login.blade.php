            ...
            <div class="card box-shad my-5">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="text-center mb-4" style="font-size: 0.8rem">
                            Nemáte účet? Registrovat se můžete <a href="/register" class="contactemail blue" style="font-size: 0.8rem">zde</a>
                        </div>
