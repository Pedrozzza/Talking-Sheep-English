...
@section('content')
    <section id="applicants">
            <div>
                <h2 class="applicants-title mb-3 mb-md-5" >Vítám tě, nový zájemce!</h2>
            </div>
        ...
        <div class="container">
                ...
                <div class="col-md-4 d-flex">
                    ...
                    <div class="text-center p-3">
                            ...
                            <ul style="background-color:white; border-radius:28px; padding:1rem; list-style:none" class="shadow">
                                <li><strong style="color:#cc0000">Víkend v Podkrkonoší</strong> - se stravou a ubytováním, výukou, hrami, výlety (2900 Kč)</li>
                                </br>
                                <li><strong style="color:#cc0000">Víkend v Chrudimi</strong> - dopolední a odpolední výuka a hry</li>
                            </ul>
                        </div>
                    </card>
                </div>
            ...
            <div class="row">
                <div class="col">
                    <h2 class="py-5 text-center condition-text">
                        Nejdříve si však musíme dát online-video pokec, kde zjistíme jak na tom se svou angličtinou jsi. 
                        Pobavíme se o všech variantách a zkusíme pro tebe vybrat ty nejvhodnější z nich
                    </h2>
                    <div class="courses">
                        ...
                        <p>
                            Bude to jiné, bude to sranda, bude to hravé a bude to efektivní. Buď u toho!
                            Přihlásit se můžeš do konce srpna. Na studenty kteří se stihnou přihlásit do 26.8. 2021 čeká malé překvapení:)
                        </p>
                        ...
                        <div id="apply" class="collapse">
                            <p>
                                ...
                                Nech mi tady na sebe telefonní a emailový kontakt, kam ti příjde sms s nabídkou termínu na video-hovor.
                                Ten může proběhnout buď přes whatsapp nebo google meet. Jsou to ty nejjednodušší varianty a 
                                s oběma ti můžu poradit.
                            </p>
                            <hr>
                            <form method="POST" action="{{ route('apply') }}">
                            @csrf
                            <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">Jméno a Přijmení</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right">Telefonní číslo</label>
